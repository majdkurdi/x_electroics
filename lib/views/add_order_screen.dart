...
Map<LocationStatus, Widget> helper = {
  LocationStatus.NO_LOCATION: Icon(Icons.gps_fixed),
  LocationStatus.WAITING_FOR_LOCATION: CircularProgressIndicator(
      valueColor: AlwaysStoppedAnimation<Color>(Colors.white)),
  LocationStatus.GIVEN_LOCATION: Icon(Icons.check, color: Colors.green)
};
